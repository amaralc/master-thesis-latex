...
\titulo{
\lang
% use \protect\\ to break lines if needed
  {
  ...
  {
    Os efeitos da espessura da parede, ângulo de inclinação e raio de curvatura na geometria resultante de componentes
    de ferro fabricados por deposição de energia direcionada a laser
  }
}
...
\area{\lang{Mechanical Manufacturing}{Fabricação Mechanica}}
...
\centro{\lang
{EMC -- Department of Mechanical Engineering, CTC -- Technological Center}
{EMC -- Departamento de Engenharia Mecânica, CTC -- Centro Tecnológico}%
}
...
\data{\lang{30 of march of}{30 de março de} 2022}
...
\palavraschaveufsc{palavraschaveingles}   {Laser Directed Energy Deposition}
\palavraschaveufsc{palavraschaveportugues}{Deposição Direcionada de Energia a Laser}

\palavraschaveufsc{palavraschaveingles}   {Geometry}
\palavraschaveufsc{palavraschaveportugues}{Geometria}
