...
\titulo{
  ...
  {Mechanical properties of low carbon steel additively manufactured by laser directed energy deposition with powder as feedstock material}
  {Propriedades mecânicas de aço de baixo carbono fabricado por deposição de energia direcionada a laser com pó como material de adição}
}
